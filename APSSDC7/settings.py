"""
Django settings for APSSDC7 project.
...
SECRET_KEY = '9x^0j7^2!bmans0i%loc!yu6s$&e3iym%%+qix1*=%cky)*&l2'
...
WSGI_APPLICATION = 'APSSDC7.wsgi.application'
